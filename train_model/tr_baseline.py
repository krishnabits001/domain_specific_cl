...
parser.add_argument('--no_of_tr_imgs', type=str, default='tr2', choices=['tr1', 'tr2','tr8','trall'])
...
save_dir=str(save_dir)+str(parse_config.no_of_tr_imgs)+'/'+str(parse_config.comb_tr_imgs)+'_v'+str(parse_config.ver)+'/unet_dsc_loss_'+str(parse_config.dsc_loss)+'_n_iter_'+str(parse_config.n_iter)+'_lr_seg_'+str(parse_config.lr_seg)+'/'
...
f1_util.plt_seg_loss([tr_loss_list,val_loss_list],save_dir,title_str='baseline',plt_name='tr_seg_loss',ep_no=epoch_i)
f1_util.plt_seg_loss([tr_dsc_list,val_dsc_list],save_dir,title_str='baseline',plt_name='tr_dsc_score',ep_no=epoch_i)
